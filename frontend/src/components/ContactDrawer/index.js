...
const ContactDrawer = ({
  ...
  return (
    <>
      <Drawer
        style={console.log('contact', contact)}
              ...
              {contact?.isGroup ? (
                <>
                  ...
                  {selectedUsers?.length > 0 ? (
                    <>
                      <Typography style={{ fontSize: 12 }}>
                        Para que as mensagens de grupo funcione como ticket e
                        entre em aguardando, é necessário remover todos os
                        membros desta lista de usuários.
                      </Typography>
                    </>
                  ) : (
                    <Typography style={{ fontSize: 12 }}>
                      Ao adicionar membros, as mensagens de atendimento entrarão
                      diretamente na aba atendendo e todos os usuários
